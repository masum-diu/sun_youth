        ...
        <Grid container spacing={4}>
          ...
          >
            ...
            <Typography
              sx={{
                ...
                cursor: "pointer",
                color:
                  router?.route === "/about-us/government-mohfw"
                    ? "#f5821f"
                    : "#000",
              }}
              onClick={() => router.push("/about-us/government-mohfw")}
            >
              Government (MoHFW)
            </Typography>
            <Divider
            ...
            <Typography
              sx={{
                ...
                cursor: "pointer",
                color:
                  router?.route === "/about-us/secretariat-gain"
                    ? "#f5821f"
                    : "#000",
              }}
              onClick={() => router.push("/about-us/secretariat-gain")}
            >
              Secretariat (GAIN) info and logo
            </Typography>
            <Divider
              orientation="horizontal"
              variant="fullWidth"
          ...
          <Grid size={{ xs: 12, md: 9 }} py={2}>
            ...
            <Typography variant="body1" paragraph sx={{ lineHeight: 1.8 }}>
              ...
              consequatur asperiores! Aspernatur minus iusto natus magni commodi
              unde tempora accusamus aliquid qui? Similique debitis dignissimos
              eveniet corrupti cumque nobis necessitatibus nesciunt recusandae
              voluptates tenetur quam magni doloremque, reprehenderit, earum
              labore eaque nostrum soluta? Esse voluptate, earum facilis sequi
              inventore quasi asperiores nostrum, non aut provident nemo
              temporibus amet accusantium quisquam quos cupiditate a quis!
              Labore esse facere, possimus est iusto cum dolores nihil, sit illo
              doloremque nesciunt molestiae voluptate exercitationem, adipisci
              laudantium dolore expedita ratione deleniti! Id deleniti
              recusandae, ullam eligendi quos illum iusto velit nostrum commodi
              neque doloribus. Magnam quasi voluptates, quam exercitationem
              eligendi fuga est et, reprehenderit eius doloribus id. Libero
              voluptas rem optio. Unde saepe omnis officiis explicabo temporibus
