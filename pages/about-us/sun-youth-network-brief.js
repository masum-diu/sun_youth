  ...
  return (
    <React.Fragment>
      ...
      <Box sx={{ width: "95%", maxWidth: "1700px", margin: "0 auto" }}>
        <Grid container spacing={2}>
          <Grid size={{ xs: 12, md: 3 }} p={2} sx={{ borderRight: { md: "5px solid #f5821f" }, pr: 2, bgcolor: "#f7f3ef", height: "fit-content" }} >
            <Typography sx={{ fontWeight: 'bold', fontSize: 16, cursor: "pointer", color: router?.route === '/about-us/sun-youth-network-brief' ? "#f5821f" : "#000" }} onClick={() => router.push('/about-us/sun-youth-network-brief')}>SUN Youth Network Bangladesh Brief</Typography>
            <Divider
      ...
      <Box bgcolor={"#f7f3ef"} py={2}>
        <Grid container spacing={5} justifyContent="center" sx={{ width: "95%", maxWidth: "1700px", margin: "0 auto", my: 6 }}>
            ...
            <Stack direction={"column"}>
              <Stack direction={"row"} spacing={3} mb={2} width={"100%"} >
                ...
                <Stack direction={"column"} width={"100%"}>
                  <Typography variant="h5" fontWeight={700} fontSize={25} color='#f5821f'>Mission</Typography>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 6 }} sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", gap: 2 }}  >
            <Stack direction={"column"}>
              <Stack direction={"row"} spacing={3} mb={2} width={"100%"} >
                <Box sx={{ width: 45, height: 45, bgcolor: "  #f5821f", borderRadius: "50%" }}></Box>
                <Stack direction={"column"} width={"100%"}>
                  <Typography variant="h5" fontWeight={700} fontSize={25} color='#f5821f'>Vision</Typography>
