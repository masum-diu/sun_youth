...
function singleImpactStories() {
  const stories = [
    ...
    },
    {
      ...
      textPartTwo:
        "Alongside her involvement with Sun Youth Network Bangladesh, Nushrath developed skills in leadership, coordination and community engagement. These skills proved valuable when she organised a three day community training in Khulna, a region facing increasing salinity challenges. The training brought together young people and created a space for them to understand their place in the local food system. Participants included university representatives, Youth Development Officers, researchers and local leaders, allowing for meaningful discussion across different groups.",
      textPartThree:
